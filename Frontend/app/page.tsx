    ...
    <div>
      ...
      <div className="md:grid md:grid-cols-12 block gap-4 mt-8 items-center w-fill">
        ...
        <div className=" col-span-7 flex justify-end mt-5 mr">
          <Image src={image} alt="discovery" width={1000} height={600} />
        </div>
      </div>
      <div className="bg-gray-100 py-20">
        <p className="text-center md:text-3xl text-xl font-bold mb-5">
          Reccomendations based on your past experiences
        </p>
        ...
        <div className="flex justify-center mt-20">
          <Button className="w-3/12">
            <Link href="/auth/signin">Explore places</Link>
          </Button>
        </div>
      </div>
      <Footer />
